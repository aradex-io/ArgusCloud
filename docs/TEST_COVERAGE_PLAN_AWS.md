# CloudGraph Test Coverage Plan - AWS Dependent Tests
...
**Source:** `cloudgraph/collectors/aws/iam.py`
...
def test_iam_roles_collector():
    ...
    # Run collector
    from cloudgraph.collectors.aws.iam import collect_iam_roles
...
**Source:** `cloudgraph/collectors/aws/storage.py`
...
**Source:** `cloudgraph/collectors/aws/ec2.py`
...
**Source:** `cloudgraph/collectors/aws/compute.py`
...
**Source:** `cloudgraph/collectors/aws/security.py`
...
**Source:** `cloudgraph/collectors/aws/identity.py`
...
**Source:** `cloudgraph/collectors/aws/messaging.py`
...
**Source:** `cloudgraph/collectors/aws/org.py`
...
**Source:** `cloudgraph/collectors/aws/sts.py`
