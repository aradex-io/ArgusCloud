...
from cloudgraph.core.graph import GraphData, Edge


class HTMLExporter:
    """Export CloudGraph findings to a standalone HTML report."""
...
<head>
    ...
    <title>CloudGraph Security Report</title>
    <style>
        :root {{
            --bg-primary: #0a0d12;
            --bg-secondary: #0f1419;
...
<body>
    <div class="container">
        ...
        <footer>
            <p>CloudGraph - Multi-Cloud Security Graph Analytics</p>
        </footer>
    </div>
</body>
</html>'''
