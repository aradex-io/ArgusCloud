"""Plugin discovery and registration for CloudGraph."""
...
class PluginRegistry:
    """Registry for managing CloudGraph plugins.
    ...
    def discover(self) -> List[str]:
        ...
        Looks for plugins registered under 'cloudgraph.plugins' entry point.
        ...
        try:
            if sys.version_info >= (3, 10):
                ...
                eps = entry_points(group="cloudgraph.plugins")
            else:
                from importlib.metadata import entry_points
                all_eps = entry_points()
                eps = all_eps.get("cloudgraph.plugins", [])
