"""Base plugin class for CloudGraph extensions."""
...
class Plugin(ABC):
    """Base class for CloudGraph plugins.

    Plugins can extend CloudGraph with:
        ...
        class SchedulerPlugin(Plugin):
            ...
            def info(self) -> PluginInfo:
                return PluginInfo(
                    name="scheduler",
                    version="1.0.0",
                    description="Scheduled scan support for CloudGraph",
                    author="CloudGraph Team",
    ...
    def register_cli(self, subparsers: "argparse._SubParsersAction") -> None:
        ...
        Override this to add commands to the cloudgraph CLI.
