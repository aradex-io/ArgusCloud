"""Abstract base classes for CloudGraph repositories.
...
from cloudgraph.constants import MAX_QUERY_LIMIT
...
class GraphRepository(ABC):
    ...
    CloudGraph API. Implementations can be created for Neo4j,
